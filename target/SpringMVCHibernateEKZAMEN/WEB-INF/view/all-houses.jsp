...
<div>
  ...
  <form:form action="profileUser"  modelAttribute="showAuthUser">
    <c:url var="profileButton" value="profile">
      <c:param name="authUser" value="${showAuthUser.id}"/>   <--внутри ссылка параметр с id-->
    </c:url>
